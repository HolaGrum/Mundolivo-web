...
import { whatsappDigits } from "../config";
  ...
  return (
    <footer id="contact" className="footer bg-dark text-white mt-5 py-4">
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-12 col-md-6 text-center text-md-end">
            ...
            <div className="social-icons d-inline-flex align-items-center">
              ...
              <a href={`https://wa.me/${whatsappDigits}`} target="_blank" rel="noopener noreferrer" className="text-white me-3" aria-label="WhatsApp">
                <FaWhatsapp />
              </a>
        ...
        <div className="text-center mt-3 admin-links">
          <span className="mx-2">
            <a href="/admin/mercadolibre" title="Backoffice Mercado Libre">Backoffice ML</a>
          </span>
          <span className="mx-2">
            <a href="/dashboard" title="Panel de administración">Admin Panel</a>
          </span>
        </div>
      </div>
    </footer>
